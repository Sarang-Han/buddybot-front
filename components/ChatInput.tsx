    ...
    <div className="border-t bg-white p-4">
      <div className="flex items-end space-x-2">
        ...
        <button
          onClick={onOpenFAQ}
          disabled={disabled}
          className="bg-accent-yellow-green text-white rounded-full p-3 hover:bg-accent-mint disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors flex-shrink-0"
          aria-label="자주 묻는 질문"
        >
          <svg
